...
//         //    exract and display bot's response text
...
//                     106.8-106.8V394.5c0-59-47.8-106.9-106.8-106.9zM351.7 448.2c0-29.5 23.9-53.5 53.5-53.5s53.5 23.9 53.5 
//                     53.5-23.9 53.5-53.5 53.5-53.5-23.9-53.5-53.5zm157.9 267.1c-67.8 0-123.8-47.5-132.3-109h264.6c-8.6 61.5-64.5
...
// Generate bot response using the API
const generateBotResponse = async (incomingMessageDiv) => {
    const messageElement = incomingMessageDiv.querySelector(".message-text"); // Fixed variable naming
    const requestOptions = {
        method: "POST",
        headers: { "Content-Type": "application/json" }, // Fixed "headers" typo
        body: JSON.stringify({
            contents: [{ parts: [{ text: userData.message }] }] // Fixed API request body format
        })
    };
    ...
    try {
        ...
        console.log(error);
        messageElement.innerText = "An error occurred while fetching the response.";
    } finally {
        incomingMessageDiv.classList.remove("thinking");
    }
};
